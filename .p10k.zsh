# Generated by Powerlevel10k configuration wizard on 2020-04-22 at 15:51 +03.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 03991.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean, time,
# 1 line, compact, few icons, concise, transient_prompt, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=42
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%B%m' # '%n@%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B%m' # '%n@%m'
