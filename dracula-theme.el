...
(let ((colors '(;; Upstream theme color
                ...
                (dracula-fg      "#ffffff") ; official foreground
                ;; (dracula-fg      "#f8f8f2") ; official foreground
                (dracula-comment "light pink") ; official comment
                ...
                (fg3             "#ccccc7")
                (fg4             "#b6b6b2")
                (dracula-alper   "#caa9fa")
                (dracula-alper_comment   "#44475a")
                (dracula-alper1   "#9aedfe")
                (other-blue      "#0189cc")))
      ...
      (faces '(;; default
               ...
               (highlight :foreground "#282a36" :background ,dracula-yellow, :weight bold)
               ...
               ;; (lazy-highlight :foreground "#282a36" :background ,dracula-yellow, :weight bold)  ;; alper
               (lazy-highlight :foreground ,fg2 :background ,bg3)

               (link :foreground ,dracula-cyan :underline t)
               (linum :weight bold, :foreground ,dracula-cyan :background ,dracula-bg) ;;
               (line-number :slant italic :foreground ,dracula-cyan :background ,dracula-bg)
               (minibuffer-prompt :weight bold :foreground ,dracula-pink)

               (region :background ,dracula-yellow :foreground ,"#000000" :extend t)
               ; (region :background ,dracula-yellow :foreground ,"#000000" :extend t) ;alper
               ...
               (error :foreground ,dracula-red :weight bold)
               (header-line :background ,dracula-bg)

               (sh-escaped-newline :foreground ,dracula-orange :weight bold)

               (font-latex-warning-face :foreground ,dracula-cyan)


               (org-todo :background "#f1fa8c" :foreground "#282a36" :weight bold)
               (secondary-selection :background "#f1fa8c" :foreground "#282a36" :weight bold)

               ;;langtool
               (langtool-errline :foreground ,dracula-pink :underline t)
               (font-latex-italic-face’ :foreground ,dracula-green)

               ;; markdown
               (markdown-header-delimiter-face :foreground ,dracula-green)

               (markdown-language-keyword-face :foreground ,dracula-green)
               (markdown-markup-face :foreground ,dracula-green :weight bold)
               (markdown-url-face :foreground ,dracula-cyan)
               (markdown-link-face :foreground ,dracula-yellow)
               (markdown-bold-face :foreground ,dracula-orange :weight bold)
               (markdown-list-face :foreground ,dracula-pink :weight bold)
               (markdown-code-face :foreground ,dracula-cyan)
               ;; (smerge-upper :background "#282a38")
               ;; (smerge-base :background "#282a27")
               ;; syntax
                                        ; (font-lock-builtin-face :foreground ,dracula-orange)
               (font-lock-builtin-face :foreground ,dracula-alper :weight bold)
               (font-lock-comment-face :foreground ,dracula-comment)

               (font-lock-comment-delimiter-face :foreground ,dracula-comment)
               (font-lock-constant-face :foreground "magenta3")
               (font-lock-function-name-face :foreground ,dracula-alper :weight bold)
               ; (font-lock-keyword-face :weight bold :foreground ,dracula-pink)

               (font-lock-keyword-face :weight bold :foreground ,dracula-alper1)
               ...
               (font-lock-string-face :foreground ,dracula-green)

               (font-lock-type-face :foreground "#d7afff")
               ; (font-lock-type-face :foreground ,dracula-purple); alper
               ...
               ;; dired
               (dired-directory :foreground ,dracula-green :weight bold)
               ...
               (diredp-flag-mark :foreground ,dracula-cyan :weight bold :background ,dracula-current)
               ...
               ;; font-latex
               (font-latex-bold-face :foreground ,dracula-orange :weight bold)
               ...
               (font-latex-sectioning-3-face :foreground ,dracula-green :weight bold) ;
               (font-latex-math-face :foreground ,dracula-green) ;
               ; (font-latex-sedate-face :foreground "#6272a4") ;
               (font-latex-sedate-face :foreground ,dracula-yellow) ;
               (TeX-fold-unfolded-face :background "#f1fa8c" :foreground "#282a36" :weight bold) ;
               ...
               ;; helm
               (helm-bookmark-w3m :foreground ,dracula-green)
               (helm-buffer-not-saved :foreground ,dracula-purple :background ,dracula-bg)
               (helm-buffer-process :foreground ,dracula-green :background ,dracula-bg)
               ...
               (helm-candidate-number :foreground ,dracula-bg :background ,dracula-alper_comment)

               (helm-ff-directory :foreground ,dracula-purple :background ,dracula-bg :weight bold)
               (helm-ff-executable :foreground ,dracula-green :background ,dracula-bg :weight bold)
               (helm-ff-file :foreground ,dracula-fg :background ,dracula-bg)

               (helm-ff-invalid-symlink :foreground ,dracula-green :background ,dracula-bg :weight bold)
               (helm-ff-prefix :foreground ,dracula-bg :background ,dracula-bg :weight normal)
               (helm-ff-symlink :foreground ,dracula-green :background ,dracula-bg :weight bold)

               (helm-grep-cmd-line :foreground ,dracula-fg :background ,dracula-bg)
               (helm-grep-file :foreground ,dracula-fg :background ,dracula-bg)
               (helm-grep-finish :foreground ,dracula-green :background ,dracula-bg)
               (helm-grep-lineno :foreground ,dracula-fg :background ,dracula-bg)

               ;; (helm-grep-match :foreground "#282a36" :background "#f1fa8c")
               (helm-grep-match :foreground "#282a36" :background "#f1fa8c" :inherit helm-match)
               ...
               (helm-selection :background ,dracula-alper_comment :foreground ,dracula-fg :underline nil :weight bold)

               (helm-selection-line :background ,bg2)
               (helm-separator :foreground ,dracula-purple :background ,dracula-bg :weight bold)
               (helm-source-go-package-godoc-description :foreground ,dracula-yellow)
               (helm-source-header :foreground ,dracula-green :background ,dracula-bg :underline nil :weight bold)

               (helm-time-zone-current :foreground ,dracula-orange :background ,dracula-bg)
               (helm-time-zone-home :foreground ,dracula-purple :background ,dracula-bg :weight bold)
               ...
               (icicle-search-main-regexp-others :foreground ,dracula-fg :weight bold)
               (icicle-search-current-input :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-8 :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-7 :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-6 :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-5 :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-4 :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-3 :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-2 :foreground ,dracula-purple :weight bold)
               (icicle-search-context-level-1 :foreground ,dracula-purple :weight bold)
               (icicle-search-main-regexp-current :foreground ,dracula-fg :weight bold)
               ...
               (isearch-fail  :foreground ,black_alper :background ,dracula-orange)
               ;;
               ;; jde-java
               ...
               (magit-diff-added :background ,dracula-bg
                                 :foreground ,dracula-green
                                 :extend t)

               ;; (magit-diff-removed :background "#553333"
               (magit-diff-removed :background ,dracula-bg
                                   :foreground ,dracula-red
                                   :extend t)

               ;; (magit-diff-removed-highlight :background "#663333"
               (magit-diff-removed-highlight :background ,dracula-bg
                                             :foreground ,dracula-red ;;alper
                                             :extend t)

               (magit-diff-added-highlight :background ,dracula-bg
                                           :foreground ,dracula-green
                                           :extend t)
               ...
               (org-level-1 :inherit bold :foreground ,dracula-purple :height 1.3)
               (org-level-2 :inherit bold :foreground ,dracula-pink :height 1.1)
               ...
               (org-verbatim :foreground ,dracula-orange)
               ...
               ;; show-paren
               (show-paren-match-face :background ,dracula-current
                                      :foreground ,dracula-red
                                      :underline t
                                      :weight extra-bold)

               (show-paren-match :background ,dracula-current
                                 :foreground ,dracula-red
                                 :underline t
                                 :weight bold)
               ...
               (undo-tree-visualizer-default-face :foreground ,dracula-purple) ;;old part
